...
//           <h4>Category</h4>
//           <p onClick={() => handleFilterChange("category", "tshirt")}>T-Shirts</p>
//           <p onClick={() => handleFilterChange("category", "shorts")}>Shorts</p>
//           <p onClick={() => handleFilterChange("category", "shirt")}>Shirts</p>
//           <p onClick={() => handleFilterChange("category", "hoodie")}>Hoodies</p>
//           <p onClick={() => handleFilterChange("category", "jeans")}>Jeans</p>
//         </div>
...
//         <div className="filter-section">
//           <h4>Color</h4>
//           <p onClick={() => handleFilterChange("color", "black")}>Black</p>
//           <p onClick={() => handleFilterChange("color", "blue")}>Blue</p>
//           <p onClick={() => handleFilterChange("color", "red")}>Red</p>
//         </div>

//         {/* Size */}
//         <div className="filter-section">
//           <h4>Size</h4>
//           <p onClick={() => handleFilterChange("size", "S")}>Small</p>
//           <p onClick={() => handleFilterChange("size", "M")}>Medium</p>
//           <p onClick={() => handleFilterChange("size", "L")}>Large</p>
//           <p onClick={() => handleFilterChange("size", "XL")}>XL</p>
//         </div>
//       </div>
